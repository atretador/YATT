...
namespace YATT.Services
{
    public class TorrentManagerService
    {
        ...
        public TorrentManagerService()
        {
            ...
            Directory.CreateDirectory(_fastResumeDirectory); // Ensure fast resume directory exists
            InitializeEngine(0);
        }
        ...
        public async Task<Byte[]> LoadMagneticLinkMetadata(string link)
        {
            ...
            // Initialize the TorrentManager and settings
            TorrentManager manager;

            // Attempt to retrieve torrent metadata using the magnet link
